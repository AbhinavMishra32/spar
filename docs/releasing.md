...
Automatic updates are enabled in packaged builds with `SPAR_ENABLE_UPDATES=1`. Update artifacts are signature-checked before installation and install on quit after download.
