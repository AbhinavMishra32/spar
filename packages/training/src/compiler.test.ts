...
it("materializes a bounded differential hidden counterexample",async()=>{
  ...
  expect(Object.keys(compiled.design.hiddenTests)).toContain("src/.pracai-generated-1.hidden.test.js");
});
